...
* @package pagepackage
*/
	require_once dirname( __FILE__ ) . '/smsenvoi.config.php';
...
class apismsenvoi{
	...
	*/
	...
	public function __construct($email,$apikey){
				$this->SMSENVOI_EMAIL=$email;
				$this->SMSENVOI_APIKEY=$apikey;
	...
	*/
	private function _postRequest($url,$fields){
		...
		$fields['email']=$this->SMSENVOI_EMAIL;
		$fields['apikey']=$this->SMSENVOI_APIKEY;
	...
	*/
	public function sendSMS($recipients,$content,$subtype='PREMIUM',$senderlabel='SMS ENVOI',$senddate='',$sendtime=''){
	...
	*/	 	
	public function checkCredits(){
		...
		$return=array('sms'=>array('LOWCOST'=>0,'STANDARD'=>0,'PREMIUM'=>0,'LONG'=>0,'STOP'=>0));
